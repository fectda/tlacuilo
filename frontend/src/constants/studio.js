export const SHOT_TYPES = [
    ...
    { value: 'context', icon: '◫', label: 'Contexto', desc: 'Plano medio o abierto que muestra el objeto en su entorno de operación real.' },
    ...
    { value: 'screenshot', icon: '▣', label: 'Captura', desc: 'Evidencia digital de interfaces de software, fragmentos de código o visualizaciones de datos.' },
]
...
export const SHOT_STATUS_CONFIG = {
    pending_upload: { label: 'PENDIENTE', textColor: '#6b7280', dotColor: '#4b5563' },
    queued: { label: 'EN COLA', textColor: '#f59e0b', dotColor: '#f59e0b' },
    generated: { label: 'GENERADO', textColor: '#10b981', dotColor: '#10b981' },
    approved: { label: 'APROBADO ✓', textColor: '#22d3ee', dotColor: '#22d3ee' },
}
